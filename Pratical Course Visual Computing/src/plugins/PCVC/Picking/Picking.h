#ifndef OGL4CORE2_PLUGINS_PCVC_PICKING_PICKING_H
#define OGL4CORE2_PLUGINS_PCVC_PICKING_PICKING_H
...
namespace OGL4Core2::Plugins::PCVC::Picking {
    ...
    public:
        static std::string name() { return "PCVC/Picking"; }
...
#endif // OGL4CORE2_PLUGINS_PCVC_PICKING_PICKING_H
